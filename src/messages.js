...
const messages = {
  ...
  'step_1': "Хаяо Миядзаки\n\Хаяо Миядзаки считал, что важнее всего построить студию Ghibli, как место куда приходят реализовывать себя. Airalab организация в сети Интернет и чтобы войти в неё я придумал следующую задачку.\n\n По этой <a href='http://static.aira.life/AIRA_rules.pdf'>ссылке</a> документ под названием “Согласие с правилами работы в организации”. Внутри него оригинальный текст, написанный на входе в студию Миядзаки. Найдите способ понять, что там написано и согласиться с семью пунктами правил. Распечатайте, поставьте подпись, сделайте скан и загрузите в ipfs. Хеш получившегося файла присылайте telegram боту @AiraHelperBot c помощью команды /step_1_done.\n\nP.S.: оригинал поставьте в рамочку или под стекло, красиво выглядит!\n\nПодсказка: /step_1_help",
  'step_1_done.1': "Укажите ipfs hash.",
  'step_1_done.2': "Укажите hash файла, сохраненного в ipfs",
  'step_1_done.3': "Ваш ответ принят, в ближайшее время я Вам сообщу результат.",
  'step_1_done.4': "Появился новый кандидат @{username} подписавший соглашение <a href='https://ipfs.io/ipfs/{ipfshash}'>{ipfshash}</a>. Для принятия участника выполните команду /step_1_ok",
  'step_1_ok.1': "Укажите @username кандидата.",
  'step_1_ok.2': "{username} предложено пройти следующее задание.",
  'step_1_ok.3': "Ваше первое задание успешно выполнено, теперь вы можете пройти следующее задание /step_2",
  'step_1_ok.4': "Пользователь {username} не найден(",
  'step_1_help': "Пройдя по этой <a href='https://ipfs.io/docs/getting-started/'>ссылке</a> можно прочитать как работать с ipfs",
  ...
  'step_3_done.2': "Ваш ответ принят, вы можете вступить в нашу команду <a href='https://t.me/joinchat/A6wE1EOFKp7Js3vfI2F-yw'>перейти</a>",
